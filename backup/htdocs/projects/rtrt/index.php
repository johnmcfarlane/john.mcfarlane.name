<?php 
	include "../../common.php";
	start_page("Real-time Ray Tracing", "wallpaper4", "../../");
?>
	...
	<p><img src="tracey1.jpg" border="0" alt="Ray-traced scene including space partitioning information"></p>
	<hr align="centre">
	<p>
	...
	<p><img src="tracey2.jpg" border="0" alt="Ray-traced scene with example of soft shadow"></p>
<?php finish_page();?>