...
function outputAlbums($albums, $albums_per_row = 3)
{
	...
	echo " style=\"margin-left: auto; margin-right: auto; text-align: center\">\n";

	for ($row_index = 0; $row_index < $num_rows; ++ $row_index)
	{
		outputRow($albums, $row_index, $albums_per_row, "vertical-align: middle", "outputThumbnail");
		outputRow($albums, $row_index, $albums_per_row, "vertical-align: top", "outputTitle");
		outputRow($albums, $row_index, $albums_per_row, "", FALSE);
		outputRow($albums, $row_index, $albums_per_row, "", FALSE);
	}
...
// titles alternately.
function outputRow($albums, $row_index, $albums_per_row, $style, $output_fn)
{
	echo "\t\t<tr style=\"" . $style . "\">\n";
	...
	for ($column_index = 0; $column_index < $albums_per_row; ++ $column_index)
	{
		...
		echo "\t\t\t<td colspan=\"" . $albums_per_row . "\">";
