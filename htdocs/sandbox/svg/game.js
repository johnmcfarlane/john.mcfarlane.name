...
Star.prototype.outOfMind=new coords(Star.prototype.minHeight,Star.prototype.minHeight)
Star.prototype.heightExtent=Star.prototype.maxHeight-Star.prototype.minHeight

function initStars() {
	Star.prototype.minScape=new coords(-Star.prototype.outOfMind.x*2,-Star.prototype.outOfMind.y*2)
	Star.prototype.maxScape=new coords(gRes.x,gRes.y)
...
Star.prototype.randomise=function() {
	s=parseInt(Math.random()*this.heightExtent+this.minHeight)
...
Exhaust.prototype.tick=function() {
	++this.age
	r=this.age*this.radiusDelta*this.power
	this.update(r)
...
Exhaust.prototype.update=function(r) {
	this.element.setAttribute('cx',parseInt(this.pos.x+gCenter.x-gShip.pos.x))
	this.element.setAttribute('cy',parseInt(this.pos.y+gCenter.y-gShip.pos.y))
...
/*Exhaust.prototype.setRadius=function(r) {
	v1=r>0
	if ((this.r>0)!=v1)
		e.setAttribute('visibility',v1?'visible':'hidden');
	this.r=r
}*/
